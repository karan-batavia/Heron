...
program
  ...
  .option('--llm-provider <provider>', 'LLM provider: anthropic, openai, or gemini', process.env.HERON_LLM_PROVIDER ?? 'anthropic')
  .option('--llm-model <model>', 'LLM model for analysis', process.env.HERON_LLM_MODEL ?? 'claude-sonnet-4-20250514')
